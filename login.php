  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>SMS</b> GATEWAY</a>
      </div><!-- /.login-logo -->
...
if (isset($_POST[login])){
 ...
 $admin = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE username='".anti_injection($_POST[a])."' AND password='$pass'");
